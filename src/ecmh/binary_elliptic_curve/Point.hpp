...
struct AffinePoint {
  ...
  AffinePoint() = default;
  AffinePoint(FE const &x_, FE const &y_)
    : x_(x_), y_(y_)
  {}
...
public:
  ...
  LambdaAffinePoint(FE const &x_, FE const &m_)
    : x_(x_), m_(m_)
  {}
...
public:
  ...
  LambdaProjectivePoint(FE const &x_, FE const &m_, FE const &z_)
    : LambdaAffinePoint<Curve>(x_,m_), z_(z_)
  {}
